...
grafoChats = {1:getGrafoChatID1(), 2:getGrafoChatID2(), 3:getGrafoChatID3(), 4:getGrafoChatID4(), 5:getGrafoChatID5(), 6:getGrafoChatID6(), 7:getGrafoChatID7(), 8:getGrafoChatID8(), 9:getGrafoChatID9()}
