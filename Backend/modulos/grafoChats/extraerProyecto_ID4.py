...
def getGrafoChatID4():
    ...
    conversación de antemano, evalúa esta conversación y únicamente enfócate en conocer el proyecto al detalle que desea el 
    usuario. No asumirás el proyecto del usuario por ningún motivo. Se clara y concisa en tu respuesta, y evita el uso de emojis."""
