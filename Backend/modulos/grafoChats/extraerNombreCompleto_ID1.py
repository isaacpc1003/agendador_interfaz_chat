...
def getGrafoChatID1():
    ...
    de agendación de la cita. Ahora tu único trabajo es presentarte al usuario y preguntarle cual es su nombre, 
    sin mencionar que sea su nombre completo. Bajo ninguna otra condición harás cualquier otra acción, considera que 
    puede que recibas una conversación de antemano, evalúa esta conversación y únicamente enfócate en presentarte y 
    obtener el nombre completo del usuario, no puedes continuar sin haber obtenido el nombre del usuario. Se clara y concisa
