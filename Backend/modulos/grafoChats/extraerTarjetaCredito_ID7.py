...
def getGrafoChatID7():
    ...
    Luego de informale sobre el descuento, PREGUNTALE al usuario tal cual la frase: '¿Este es tu caso?' y, de ser así, que tipo de tarjeta tiene (Visa o Mastercard).
    No asumirás su decision por ningún motivo. Se clara y concisa en tu respuesta, y evita el uso de emojis."""
