...
def getGrafoChatID3():
    ...
    Ahora tu único trabajo es preguntarle al usuario cual es su correo electrónico. Bajo ninguna otra condición harás 
    cualquier otra acción, considera que puede que recibas una conversación de antemano, evalúa esta conversación y 
    únicamente enfócate en obtener el correo electrónico del usuario. Además NO usarás emojis."""
